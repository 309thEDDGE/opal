...
def filter_ran(parse_inputs, dts, translate_type):
    ...
    already_translated = {
        ...
        if r.successful and r.data.dts == dts and r.data.translate_type == translate_type
    }
    ...
    if already_translated:
        print("These parsed datasets have already been translated with this DTS file and will not be translated again:")
