...
st.write(
    "Examples below were taken from:  https://streamlit.io/docs/getting_started.html#get-started"
)
...
st.code(
    """
this comes from my local directory
df = pandas.DataFrame({
    'first column': [one, two, three],
    'second column': [1, 3, 5]
})
""",
    language="python",
...
if st.checkbox("Show in sidebar"):
    option = st.sidebar.selectbox("Which number do you like best?", ["a", "b", "c"])
